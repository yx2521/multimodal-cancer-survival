...
class WSIProtoDataset(Dataset):
    ...
    def __init__(self,
        ...
        for src in data_source:
            ...
            # CHANGE: Check if the source is a directory and determine the type of features
            basename = os.path.basename(src)
            if (basename == 'feats_h5' or src.endswith('.h5')):
                self.use_h5 = True
            elif ('uni_v1' in src or 'clam_gen' in src or basename == 'feats_pt'):
                self.use_h5 = False  # npy/pt
            else:
                self.use_h5 = False  # npy/pt
